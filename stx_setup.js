...
const features = [
    {
        ...
        steps: [
            { file: 'README.md', content: '# Stx-conapp\n\nStarting project...', msg: 'docs: init README' },
...
// Helper to generate more micro-commits
...
// Generate enough features to reach 500 commits
// Current: ~20 commits. 
// Need 480 more.
// Each granular feature has 1 + 6*2 = 13 commits (steps) + merge commit = 14 commits.
// 480 / 14 ~ 35 features.
const extraFeatures = generateGranularCommits('Automated', 35);
